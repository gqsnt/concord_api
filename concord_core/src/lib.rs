...
pub mod internal {
    ...
    pub use crate::pagination::{
        ...
        PageApplyResult, PageDecision, PageInit, PageRequest, PagedPagination, PaginationCaps,
...
pub mod advanced {
    ...
    pub use crate::pagination::{
        ...
        PageDecision, PageInit, PageItems, PageRequest, PaginationCaps, PaginationController,
